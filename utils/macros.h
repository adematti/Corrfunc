...
#define XASSERT(EXP, ...)                                               \
     do { if (!(EXP)) {                                                 \
             ...
             fprintf(stderr,ANSI_COLOR_BLUE "Hopefully, input validation. Otherwise, bug in code: please file an issue on GitHub: https://github.com/adematti/Corrfunc/issues"ANSI_COLOR_RESET"\n"); \
             return EXIT_FAILURE;                                       \
         }                                                              \
     } while (0)
#endif
