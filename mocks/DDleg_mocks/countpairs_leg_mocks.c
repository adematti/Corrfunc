...
#include "countpairs_leg_mocks.h" //function proto-type for API
#include "countpairs_leg_mocks_impl_double.h"//actual implementations for double
#include "countpairs_leg_mocks_impl_float.h"//actual implementations for float


void free_results_mocks_leg(results_countpairs_mocks_leg *results)
{
    if(results == NULL)
        return;
...
int countpairs_mocks_leg(const int64_t ND1, void * restrict X1, void * restrict Y1, void * restrict Z1,
                            ...
                            struct extra_options *extra)
{
    ...
    if(options->float_type == sizeof(float)) {
        return countpairs_mocks_leg_float(ND1, (float *) X1, (float *) Y1, (float *) Z1,
        ...
        return countpairs_mocks_leg_double(ND1, (double *) X1, (double *) Y1, (double *) Z1,
